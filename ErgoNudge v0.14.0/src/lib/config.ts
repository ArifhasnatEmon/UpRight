...
export const POSTURE_THRESHOLDS = {
  ...
  NECK_LOOKING_UP: -0.18,
  /** Pitch diff above this → looking down (neck flexion / forward head) */
  NECK_LOOKING_DOWN: 0.25,
...
// MediaPipe config — local files bundled in public/mediapipe-pose/ for offline support
export const MEDIAPIPE_CDN_URL = './mediapipe-pose/';
